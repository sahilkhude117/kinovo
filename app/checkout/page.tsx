...
const CheckoutPage: React.FC<CheckoutPageProps> = () => {
  ...
  const sampleOrder: OrderData = {
    items: [
      {
        id: '1',
        name: 'Kinovo Brain Enchantment Kit',
        description: '14000+ kids worksheets ',
        price: 199,
        quantity: 1
      }
    ],
    ...
    <div className="min-h-screen bg-white text-black p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-4xl md:text-5xl font-baloo font-bold mb-8 tracking-tight">
                Billing details
              </h1>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="firstName" className="text-gray-600 text-sm font-antique-olive">
                  ...
                  <Input
                    ...
                    className={`bg-gray-50 border transition-all duration-200 font-antique-olive ${
                ...
                <div className="space-y-2">
                  <Label htmlFor="lastName" className="text-gray-600 text-sm font-antique-olive">
                    Last name (Optional)
                  </Label>
                  <Input
                    id="lastName"
              ...
              {/* Phone Field */}
              <div className="space-y-2">
                <Label htmlFor="phone" className="text-gray-600 text-sm font-antique-olive">
                ...
                <Input
                  ...
                  className={`bg-gray-50 border transition-all duration-200 font-antique-olive ${
                    errors.phone ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-[#13C0FA]'
                  } text-black focus:ring-[#13C0FA]/20`}
                />
                {errors.phone && (
              ...
              {/* Email Field */}
              <div className="space-y-2">
                <Label htmlFor="email" className="text-gray-600 text-sm font-antique-olive">
              ...
              <div className="space-y-2">
                <Label htmlFor="howDidYouHear" className="text-gray-600 text-sm">
                ...
                >
                  <SelectTrigger className={`border transition-all duration-200 ${
                  ...
                  <SelectContent className="border-gray-500">
                    ...
                    <SelectItem value="Social Media" className="hover:bg-gray-800">Social Media</SelectItem>
                    <SelectItem value="Friend Referral" className="hover:bg-gray-800">Friend Referral</SelectItem>
                    <SelectItem value="Advertisement" className="hover:bg-gray-800">Advertisement</SelectItem>
                  </SelectContent>
                </Select>
              ...
              <CardContent className="space-y-4">
                ...
                {order.items.map((item) => (
                  <div key={item.id} className="flex justify-between items-start">
                    <div>
                      <h3 className="text-black font-medium font-antique-olive">{item.name}</h3>
                      <p className="text-gray-500 text-sm font-antique-olive">
                ...
                <div className="flex justify-between">
                  <p className="text-gray-600 font-antique-olive">Subtotal</p>
                  <p className="text-black font-antique-olive">{formatCurrency(order.subtotal)}</p>
                </div>

                {order.tax && (
                  <div className="flex justify-between">
                    <p className="text-gray-600 font-antique-olive">Tax</p>
                ...
                {order.discount && (
                  <div className="flex justify-between">
                    <p className="text-green-600 font-antique-olive">Discount</p>
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="pl-7 pt-4">
                  <p className="text-gray-400 text-sm leading-relaxed">
                    ...
                    <Link href="/privacy-policy" className="text-[#13C0FA] cursor-pointer transition-colors hover:underline">
                      privacy policy
                    </Link>.
                  </p>
                </div>
      ...
      <Dialog open={showTestModal} onOpenChange={setShowTestModal}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>Test Mode - Form Validation Passed</DialogTitle>
            <DialogDescription className="space-y-4">
              <div className="text-sm space-y-2">
                ...
                <p>Source: {formData.howDidYouHear}</p>
              </div>
              <div className="text-sm space-y-2">
                <p><strong>Order Summary:</strong></p>
                <p>Total Amount: {formatCurrency(order.total)}</p>
                <p>Items: {order.items.length}</p>
              </div>
              <p className="text-xs text-gray-500">
                This is a test modal. In production, this would redirect to payment gateway.
              </p>
            </DialogDescription>
          </DialogHeader>
          <div className="flex gap-2 mt-4">
            ...
            <Button 
              ...
              className="flex-1 bg-[#13C0FA] hover:bg-[#13C0FA]/90"
            >
              Continue
            </Button>
          </div>
