  ...
  const onBuy = async () => {
    try {
      ...
      const response = await axios.post('/api/payment/create-order', {
        ...
        phone: formData.howDidYouHear,
        productId: order.items[0].id,
      });

      const rzorder = response.data.order;
      await handlePurchase(rzorder);
    } catch (error) {
        ...
        handler: async (response: RazorpayResponse) => {
          ...
          try {
            ...
            if (verify.data.success) {
              window.location.href = `/payment/success/${verify.data.purchaseId}`;
            } else {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div id='billing' className="space-y-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-2 md:space-y-6">
              ...
              {/* Phone Field */}
              <div className="space-y-2">
                <Label htmlFor="phone" className="text-gray-600 text-xs md:text-sm font-antique-olive">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent className="border-gray-500">
                    ...
                    <SelectItem value="Social Media" className="hover:bg-gray-800">Instagram</SelectItem>
                    <SelectItem value="Friend Referral" className="hover:bg-gray-800">Friend Referral</SelectItem>
                    <SelectItem value="Advertisement" className="hover:bg-gray-800">Facebook</SelectItem>
                  </SelectContent>
                </Select>
